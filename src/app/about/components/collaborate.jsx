export default function Collaborate() {
    return (
      ...
      2xl:max-w-[70%]  ">
        {/* Título principal */}
        <h1 className="  text-[#025A4E] dark:text-[#8fdcc2] mb-10 leading-snug text-left font-Acorn"
        ...
        {/* Texto descriptivo */}
        <p className="leading-relaxed text-[#546d69] dark:text-[#d4ede4] font-AcornRegular text-left font-RegularAcorn"
