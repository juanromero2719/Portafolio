  ...
  return (
    <>
      ...
      ">
        ...
        <h1
          className="ml-5 font-Acorn text-center leading-[1.1] tracking-[-2px] flex flex-col justify-center 
          text-[#025A4E] dark:text-[#8fdcc2]" 
      ...
      <h4
        className="font-ThinAcorn font-bold text-center text-[#546d69] dark:text-[#d4ede4] mx-[5vw] my-[2vh] 
        sm:mt-[4%]"
